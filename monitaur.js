/*!
 * monitaur v0.0.28 (https://github.com/jeremycoulter/monitaur)
...
function getTaskIcon(description) {
    var keywords = ["appointment", "band", "beer", "breakfast", "brewery", "call", "clean", "coffee", "compost", "development", "dinner", "documentation", "fermentaur", "financial", "french", "garbage", "gig", "gym", "humidifier", "launder", "lunch", "meet", "monitaur", "piano", "pristiq", "promo", "pubsley", "recycling", "remeron", "renovation", "repair", "shopping", "shower", "television", "therapy", "yardwaste", "yardwork"];
    var iconHtml = "";
