/*!
 * Monitaur v0.0.9 (https://github.com/jeremycoulter/monitaur)
...
function getTaskIcon(description) {
    var keywords = ["clean", "coffee", "development", "dinner", "documentation", "french", "gym", "laundry", "lunch", "meet", "monitaur", "piano", "pristiq", "pubsley", "shopping", "shower", "yardwork"];
    var iconHtml = "";
