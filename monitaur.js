/*!
 * monitaur v0.0.25 (https://github.com/jeremycoulter/monitaur)
...
function getTaskIcon(description) {
    var keywords = ["appointment", "band", "beer", "breakfast", "brewery", "call", "clean", "coffee", "compost", "development", "dinner", "documentation", "financial", "french", "garbage", "gig", "gym", "launder", "lunch", "meet", "monitaur", "piano", "pristiq", "promo", "pubsley", "recycling", "renovation", "repair", "shopping", "shower", "television", "therapy", "yardwaste", "yardwork"];
    var iconHtml = "";
