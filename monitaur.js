/*!
 * Monitaur v0.0.15 (https://github.com/jeremycoulter/monitaur)
...
function getTaskIcon(description) {
    var keywords = ["beer", "breakfast", "brewery", "clean", "coffee", "development", "dinner", "documentation", "french", "garbage", "gig", "gym", "laundry", "lunch", "meet", "monitaur", "piano", "pristiq", "promo", "pubsley", "recycling", "shopping", "shower", "yardwaste", "yardwork"];
    var iconHtml = "";
