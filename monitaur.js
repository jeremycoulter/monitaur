/*!
 * Monitaur v0.0.10 (https://github.com/jeremycoulter/monitaur)
...
function getTaskIcon(description) {
    var keywords = ["breakfast", "clean", "coffee", "development", "dinner", "documentation", "french", "gym", "laundry", "lunch", "meet", "monitaur", "piano", "pristiq", "pubsley", "shopping", "shower", "yardwork"];
    var iconHtml = "";
