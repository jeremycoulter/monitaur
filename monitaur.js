/*!
 * Monitaur v0.0.13 (https://github.com/jeremycoulter/monitaur)
...
function getTaskIcon(description) {
    var keywords = ["beer", "breakfast", "brewery", "clean", "coffee", "development", "dinner", "documentation", "french", "garbage", "gym", "laundry", "lunch", "meet", "monitaur", "piano", "pristiq", "pubsley", "recycling", "shopping", "shower", "yardwaste", "yardwork"];
    var iconHtml = "";
